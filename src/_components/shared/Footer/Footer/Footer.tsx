          ...
          <div className="footer-2 leading-[150%] text-[#CACACA] border-t border-white pt-[35px] max-w-[1154px] mx-auto mt-[35px] flex flex-col lg:flex-row lg:gap-[117px]">
            ...
            <div className="w-[177px]  mx-auto lg:mx-0 text-center lg:text-start">
              ...
              <ul className="mulish-regular lg:text-base text-sm">
                ...
                <Link href={"/UAE"}>
                  <li className="hover:text-blue-600">UAE</li>
                </Link>
                <Link href={"/Georgia"}>
                  <li className="hover:text-blue-600">Georgia</li>
                </Link>
                <Link href={"/Finland"}>
                  <li className="hover:text-blue-600">Finland</li>
                </Link>
                <Link href={"/Cyprus"}>
                  <li className="hover:text-blue-600">Cyprus</li>
                </Link>
                <Link href={"/Switzerland"}>
                  <li className="hover:text-blue-600">Switzerland</li>
                </Link>
                <Link href={"/France"}>
                  <li className="hover:text-blue-600">France</li>
                </Link>
                <Link href={"/West-Indies"}>
                  <li className="hover:text-blue-600">West-Indies</li>
                </Link>
              </ul>
            </div>
