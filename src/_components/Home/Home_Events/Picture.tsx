...
const Picture = () => {
    ...
    return (
        <div className='events-bg max-w-[1254px]  mx-auto relative pl-[50px] pr-[50px]'>
            ...
            <div className='absolute left-[50%] -translate-x-1/2 slide-pos-left2 carousel-1 w-full'>
                <picture>
                    <source media='(max-width: 640px)' srcSet='https://i.ibb.co.com/cwm2767/Higher-Education-Fair-Abuja-Square.png'></source>
                    <source media='(max-width: 768px)' srcSet='https://i.ibb.co.com/cwm2767/Higher-Education-Fair-Abuja-Square.png'></source>
                    <Image className='w-auto h-auto' width={100} height={100} src="https://i.ibb.co.com/P69D1f2/Indian-Multi-destination-expo-event-Banner.png" alt="Indian Multi-destination Expo Event Banner" onClick={slideNext} />
                </picture>
            </div>
